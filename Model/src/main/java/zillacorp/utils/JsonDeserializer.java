...
public class JsonDeserializer 
{
    ...
    public static HistoryResponse deserializeHistoryResponse(String serializedMessage) 
    {
        Gson gson = new Gson();
        
        try 
        {
            HistoryResponse historyResponse = gson.fromJson(serializedMessage, HistoryResponse.class);
